...
def bucc_extract(cand2score, th, fname, encoding):
    if fname:
...
def bucc_eval(candidates_file, gold_file, src_file, trg_file, src_id_file, trg_id_file, predict_file, threshold=None,
              encoding='utf-8'):
